...
begin
  Clipboard.AsText := 'Lazarus Revanant ' + LazarusVersionStr + ' (rev ' + LazarusRevisionStr + ')' +
...
var
  ...
  ScaleFactor: Double;
begin
  LogoImage.Picture.LoadFromResourceName(HInstance, 'splash_about', TPortableNetworkGraphic);
